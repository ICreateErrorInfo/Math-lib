...
namespace Math_lib
{
    public class Bounds3D
    {
        ...
        public Bounds3D()
        {
            ...
            pMin = new Point3D(maxNum);
            pMax = new Point3D(minNum);
        }
        ...
        public static Bounds3D Intersect(Bounds3D b, Bounds3D b1)
        {
            Debug.Assert(IsNaN(b));
            Debug.Assert(IsNaN(b1));
        ...
        public static bool Overlaps(Bounds3D b, Bounds3D b1)
        {
            Debug.Assert(IsNaN(b));
            Debug.Assert(IsNaN(b1));
