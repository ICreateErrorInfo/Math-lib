...
namespace Raytracing.Tests {
    ...
    internal class BVHTests
    {
        ...
        public void TestCtor1()
        {
            ...
            var checker = new CheckerTexture(new RGBAlbedoSpectrum(cs, new(.2, .3, .1 )), new RGBAlbedoSpectrum(cs, new(.9, .9, .9 )));

            var material2 = new Metal(new RGBAlbedoSpectrum(cs, new(0.90, 0.76, 0.46)), 0);
            var material3 = new Metal(new RGBAlbedoSpectrum(cs, new(0.65, 0.77, 0.97)), 0);
            var material4 = new Metal(new RGBAlbedoSpectrum(cs, new(0.90, 0.90, 0.90)), 0);
