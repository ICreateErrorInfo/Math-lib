...
namespace Raytracing.Tests
{
    ...
    internal class BVHTests
    {
        ...
        public void TestCtor1()
        {
            ...
            primitives.Add(new GeometricPrimitive(new Sphere(new Point3D(5, -1, -15), 2), material2));
            ...
            BVHAccelerator BVH = new BVHAccelerator(primitives, 2, BVHAccelerator.SplitMethod.EqualCounts);
        }
    }
}
